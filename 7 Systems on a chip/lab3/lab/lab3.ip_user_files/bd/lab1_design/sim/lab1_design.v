...
(* CORE_GENERATION_INFO = "lab1_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=lab1_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=14,numNonXlnxBlks=1,numHierBlks=6,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_board_cnt=7,da_mb_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "lab1_design.hwdef" *) 
module lab1_design
  ...
  lab1_design_getFilterOut_0_2 getFilterOut_0
       (.ap_clk(microblaze_0_Clk),
        .ap_rst_n(1'b0),
        .s_axi_AXILiteS_ARADDR({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .s_axi_AXILiteS_ARVALID(1'b0),
        .s_axi_AXILiteS_AWADDR({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .s_axi_AXILiteS_AWVALID(1'b0),
        .s_axi_AXILiteS_BREADY(1'b0),
        .s_axi_AXILiteS_RREADY(1'b0),
        .s_axi_AXILiteS_WDATA({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .s_axi_AXILiteS_WSTRB({1'b1,1'b1,1'b1,1'b1}),
        .s_axi_AXILiteS_WVALID(1'b0));
