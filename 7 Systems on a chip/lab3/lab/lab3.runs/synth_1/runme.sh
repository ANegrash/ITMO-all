...
HD_PWD='E:/SoC/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_design_wrapper.tcl
