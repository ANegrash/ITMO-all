...
HD_PWD='C:/Users/User/ITMO/SoC/lab1/lab1.runs/lab1_design_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_design_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_design_ilmb_bram_if_cntlr_0.tcl
