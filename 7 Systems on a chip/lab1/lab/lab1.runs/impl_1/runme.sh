...
HD_PWD='E:/SoC/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1_design_wrapper.tcl -notrace
