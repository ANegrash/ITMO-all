...
#
# Generated by export_simulation on Fri Nov 03 16:48:35 +0300 2023
#
################################################################################
...
'-reset_run' switch to the './lab1_design.sh' script.

./lab1_design.sh -reset_run
...
./lab1_design.sh -noclean_files

For more information on the script, please type './lab1_design.sh -help'.
