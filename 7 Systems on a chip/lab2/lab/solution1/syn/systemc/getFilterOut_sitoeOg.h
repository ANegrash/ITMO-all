...
// ==============================================================
#ifndef __getFilterOut_sitoeOg__HH__
#define __getFilterOut_sitoeOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(getFilterOut_sitoeOg) {
    ...
    SC_CTOR(getFilterOut_sitoeOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
