...
// ==============================================================
# 1 "E:/SoC/lab2/filter_tb.c"
# 1 "E:/SoC/lab2/filter_tb.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "E:/SoC/lab2/filter_tb.c" 2
...
# 6 "E:/SoC/lab2/filter_tb.c" 2




_Bool golden_getFilterResult(int inputs[10], unsigned short depth, int res[10]) {
 if (depth < 3 || depth > 10) return 0;
...
_Bool float_eq(float tolerance, float a, float b) {
 return abs(a-b) < tolerance;
}

#ifndef HLS_FASTSIM
#ifndef HLS_FASTSIM
#include "apatb_getFilterOut.h"
#endif
# 28 "E:/SoC/lab2/filter_tb.c"
int main() {
 srand(100);
 for (size_t i = 0; i < 5; ++i) {
  ...
  _Bool dut_success = 0;
  _Bool golden_success = golden_getFilterResult(inputs, test_depth, golden_out);

  
#ifndef HLS_FASTSIM
#define getFilterOut AESL_WRAP_getFilterOut
#endif
# 43 "E:/SoC/lab2/filter_tb.c"
