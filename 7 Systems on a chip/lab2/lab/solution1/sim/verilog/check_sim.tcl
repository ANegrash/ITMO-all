...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.getFilterOut.autotvin_inputs.dat"
         "c.getFilterOut.autotvin_depth.dat"
         "c.getFilterOut.autotvin_out_r.dat"
         "c.getFilterOut.autotvout_out_r.dat"
         "c.getFilterOut.autotvout_out_correct.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.getFilterOut.autotvout_out_r.dat"
         "rtl.getFilterOut.autotvout_out_correct.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
