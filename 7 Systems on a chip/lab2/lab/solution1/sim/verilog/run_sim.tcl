...
if {[file isfile getFilterOut.autotvin.dat]} {
	file delete -force getFilterOut.autotvin.dat
}

if {[file isfile getFilterOut.autotvout.dat]} {
	file delete -force getFilterOut.autotvout.dat
}
