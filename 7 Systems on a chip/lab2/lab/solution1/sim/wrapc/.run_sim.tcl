...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "getFilterOut.autotvin.dat"
	set constFileTvOut       "getFilterOut.autotvout.dat"
	set constFileHdlTvIn     "getFilterOut.autohdltvin.dat"
	set constFileHdlTvOut    "getFilterOut.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
