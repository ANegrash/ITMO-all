...
void AESL_WRAP_getFilterOut(signed int *, signed short , signed int *, bool *);
...
static  char aesl_internal__OC_str5[15] = "Position: %zu\n";
static  char aesl_internal__OC_str6[16] = "Golden out: %d\n";
static  char aesl_internal__OC_str7[13] = "DUT out: %d\n";
static  char aesl_internal_str[28] = "TEST FAILED! Wrong success!";
static  char aesl_internal_str1[27] = "TEST FAILED! Wrong answer!";
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_getFilterOut(i32* %%1, i16 zeroext %%28, i32* %%3, i1* %%dut_success) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_268_count);
  AESL_WRAP_getFilterOut((signed int *)llvm_cbe_tmp__27, llvm_cbe_tmp__51, (signed int *)llvm_cbe_tmp__29, (bool *)(&llvm_cbe_dut_success));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__51);
}
if (AESL_DEBUG_TRACE)
...
llvm_cbe_tmp__81:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([28 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
llvm_cbe_tmp__83:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts3 = call i32 @puts(i8* getelementptr inbounds ([27 x i8]* @aesl_internal_str1, i64 0, i64 0)), !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts3_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @aesl_internal_.str5, i64 0, i64 0), i64 %%storemerge2) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_315_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__71);
if (AESL_DEBUG_TRACE)
printf("\n  %%54 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str6, i64 0, i64 0), i32 %%53) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_317_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__73);
if (AESL_DEBUG_TRACE)
printf("\n  %%56 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @aesl_internal_.str7, i64 0, i64 0), i32 %%55) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_319_count);
...
llvm_cbe_tmp__79:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts4 = call i32 @puts(i8* getelementptr inbounds ([8 x i8]* @aesl_internal_str2, i64 0, i64 0)), !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts4_count);
