...
## IP Info
set Vendor      "a_negrash"
set Library     "hls"
set IPName      "getFilterOut"
set Version     "0.0"
set DisplayName "a_negrash-ip-block"
set Revision    "0"
...
## Variables
set Top "getFilterOut"
set TopNoPrefix "getFilterOut"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x80 depth W 0x0 "Data signal of depth" {{0 16 depth W 0 "Bit 15 to 0 Data signal of depth"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x100 out_correct R 0x0 "Data signal of out_correct" {{0 1 out_correct R 0 "Bit 0 to 0 Data signal of out_correct"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x104 out_correct_ctrl R 0x0 "Control signal of out_correct" {{0 1 out_correct_ap_vld R 0 "Control signal out_correct_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "inputs {base_address 64 range 64} out_r {base_address 192 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
