...
HLS_SOURCES = ../../../filter_tb.c ../../../filter.c
...
$(ObjDir)/filter_tb.o: ../../../filter_tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../filter_tb.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/filter_tb.d

$(ObjDir)/filter.o: ../../../filter.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../filter.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
